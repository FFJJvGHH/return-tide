...
namespace ReturnTide.Workshop {
 ...
 public class WorkshopPart:MonoBehaviour {
  ...
  public bool Removed{get;private set;}public bool Broken=>Hits>=specimen.game.balance.boneHits;
  ...
  public string Hint(WorkshopTool tool){
   ...
   return layer==TissueLayer.Core?"夹取晶核 → 右侧托盘":layer==TissueLayer.Organ?"移开器官 → 右侧托盘":"取出碎骨 → 右侧托盘";
  }
